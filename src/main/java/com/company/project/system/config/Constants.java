//package com.company.project.system.config;
//
//
...
//
//
//    public static String es_cluster_name_test = SysConfig.getProp("es.cluster.test");
//
//    public static String es_cluster_ip_test = SysConfig.getProp("es.ip.test");
//
//    public static int es_cluster_port_test = Integer.valueOf(SysConfig.getProp("es.port.test"));
//
//
